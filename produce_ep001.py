...
def assemble_video():
    """Assemble the final video using the video_assembler engine."""
    from app.services.video_assembler import (
        AssemblyProject, SceneClip, TextOverlay, assemble_video as run_assembly
    )
    ...
    print("[ASSEMBLE] Starting video assembly...")
